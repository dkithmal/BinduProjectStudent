/****************************************************************************
** Meta object code from reading C++ file 'openhomework.h'
**
...
#error "The header file 'openhomework.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_OpenHomeWork_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 47, 17)
    ...
    "OpenHomeWork\0on_lWSelectSubject_clicked\0"
    "\0index\0on_pBOpen_clicked\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_OpenHomeWork[] = {
...
void OpenHomeWork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_lWSelectSubject_clicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
...
const QMetaObject *OpenHomeWork::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *OpenHomeWork::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
