/****************************************************************************
** Meta object code from reading C++ file 'opennote.h'
**
...
#error "The header file 'opennote.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_OpenNote_t, stringdata) + ofs \
...
static const uint qt_meta_data_OpenNote[] = {
...
const QMetaObject *OpenNote::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *OpenNote::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
